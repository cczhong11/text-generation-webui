...
settings = {
    ...
    "name1": "You",
    "name2": "Assistant",
    "context": "这是一次与助理的对话。它是一个计算机程序，旨在帮助你完成各种任务，如回答问题、提供建议和帮助决策。您可以向它提出任何问题，它都会尽力为您提供准确的相关信息。",
    "greeting": "",
    "turn_template": "",
...
parser.add_argument(
    "--gptq-for-llama",
    action="store_true",
    help="Use GPTQ-for-LLaMa to load the GPTQ model instead of AutoGPTQ.",
)
...
# FlexGen
parser.add_argument(
    "--flexgen", action="store_true", help="Enable the use of FlexGen offloading."
)
parser.add_argument(
    "--percent",
    type=int,
